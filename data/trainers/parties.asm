...
BrunoData:
	db $FF, 86, ONIX, 88, HITMONCHAN, 86, HITMONLEE, 88, ONIX, 89, MACHAMP, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 19, FEAROW, 21, RATICATE, 23, SANDSHREW, 24, EEVEE, 0
; Pokémon Tower 2F
	db $FF, 34, FEAROW, 33, SHELLDER, 32, GROWLITHE, 33, KADABRA, 35, JOLTEON, 0
	db $FF, 34, FEAROW, 33, MAGNEMITE, 32, GYARADOS, 33, KADABRA, 35, FLAREON, 0
	db $FF, 34, FEAROW, 33, VULPIX, 32, SCYTHER, 33, KADABRA, 35, VAPOREON, 0
; Silph Co. 7F
	db $FF, 44, PARASECT, 44, MAROWAK, 43, GYARADOS, 45, ALAKAZAM, 46, JOLTEON, 0
	db $FF, 44, DODRIO, 44, CLOYSTER, 43, ELECTABUZZ, 45, ALAKAZAM, 46, FLAREON, 0
	db $FF, 44, PORYGON, 44, VICTREEBEL, 43, PRIMEAPE, 45, ALAKAZAM, 46, VAPOREON, 0
; Route 22
	db $FF, 47, SANDSLASH, 45, EXEGGCUTE, 45, NINETALES, 47, CLOYSTER, 50, KADABRA, 5, JOLTEON, 0
